...
class __TwigTemplate_0478ff01541c1c7c7dbe78f2eb5275ede1238713ef2aaa0a4003e12dd098ef5a extends Twig_Template
{
    private $source;
...
";
        // line 12
        if ((twig_get_attribute($this->env, $this->source, (isset($context["admin"]) || array_key_exists("admin", $context) ? $context["admin"] : (function () { throw new Twig_Error_Runtime('Variable "admin" does not exist.', 12, $this->source); })()), "hasAccess", [0 => "list"], "method") && twig_get_attribute($this->env, $this->source, (isset($context["admin"]) || array_key_exists("admin", $context) ? $context["admin"] : (function () { throw new Twig_Error_Runtime('Variable "admin" does not exist.', 12, $this->source); })()), "hasRoute", [0 => "list"], "method"))) {
            // line 13
            echo "    <li>
        <a class=\"sonata-action-element\" href=\"";
            // line 14
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["admin"]) || array_key_exists("admin", $context) ? $context["admin"] : (function () { throw new Twig_Error_Runtime('Variable "admin" does not exist.', 14, $this->source); })()), "generateUrl", [0 => "list"], "method"), "html", null, true);
            echo "\">
...
{% endif %}
", "@SonataAdmin/Button/list_button.html.twig", "C:\\xampp\\htdocs\\youcycle\\vendor\\sonata-project\\admin-bundle\\src\\Resources\\views\\Button\\list_button.html.twig");
    }
}
