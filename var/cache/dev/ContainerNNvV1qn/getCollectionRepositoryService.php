...
// Returns the private 'App\Repository\CollectionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CollectionRepository.php';

return $this->privates['App\Repository\CollectionRepository'] = new \App\Repository\CollectionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
