...
// Returns the private 'App\Repository\BinRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\BinRepository.php';

return $this->privates['App\Repository\BinRepository'] = new \App\Repository\BinRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
